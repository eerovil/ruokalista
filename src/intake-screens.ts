...
import intakeClient from "./generated/intake.ts";
...
function intakeForm(
  ...
  return html`<form class="stacked" id="intake"
      data-max-pages="${MAX_IMAGES}"
      data-max-page-bytes="${MAX_PAGE_BASE64_BYTES}"
      data-max-pages-bytes="${MAX_PAGES_BASE64_BYTES}">
      ${target === undefined
        ? ""
