...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: `npx wrangler dev --ip 127.0.0.1 --port ${browserPort} --var SOSTOSLISTA_SERVICE_URL:${sOstoslistaOrigin} --var SOSTOSLISTA_API_TOKEN:test-s-ostoslista-token --var SOSTOSLISTA_HOUSEHOLD_ID:1 --var CAST_APP_ID:test-cast-app`,
