...
| `64-cast-receiver-long.png` | Proposed Cast receiver on a Nest Hub-sized screen: a twenty-line ingredient list folded into two columns beside the preparation instead of shrunk to fit |
